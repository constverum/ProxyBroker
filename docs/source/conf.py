...
latex_documents = [
    (master_doc, 'proxybroker.tex', 'ProxyBroker Documentation',
     'Constverum', 'manual'),
]
...
man_pages = [
    (master_doc, 'proxybroker', 'ProxyBroker Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'proxybroker', 'ProxyBroker Documentation',
     author, 'ProxyBroker', 'One line description of project.',
     'Miscellaneous'),
]
